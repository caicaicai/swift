...
<a name="printing-constants-and-variables"></a>
...
point. Always use a normal optional type if you need to check for a nil value during the lifetime of a variable.
Assertions
